      ...
      >
        ...
        <div className="bg-[#141414] border border-white/[0.06] rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-[#616161]">or</span>
            <div className="flex-1 h-px bg-white/[0.06]" />
          </div>
          ...
          <div className="flex gap-1 mb-4">
            <button
              ...
              className={`flex-1 h-9 rounded-lg text-xs font-medium transition-colors ${
                mode === "login" ? "bg-[#00E676] text-black" : "bg-[#1A1A1A] text-[#9E9E9E] hover:text-white"
              }`}
            >
              Sign In
            </button>
            <button
              ...
              className={`flex-1 h-9 rounded-lg text-xs font-medium transition-colors ${
                mode === "register" ? "bg-[#00E676] text-black" : "bg-[#1A1A1A] text-[#9E9E9E] hover:text-white"
              }`}
            >
              Register
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                className="w-full h-11 px-4 pr-10 bg-[#0C0C0C] border border-white/[0.06] rounded-xl text-sm text-white placeholder:text-[#616161] focus:outline-none focus:border-[#00E676]/40"
                required
                minLength={6}
              />
              <button
        ...
        {/* Footer */}
        <p className="text-center text-xs text-[#616161] mt-6">
          OmegaElz CRM v1.0 · South Africa
        </p>
      </motion.div>
    </div>
  );
